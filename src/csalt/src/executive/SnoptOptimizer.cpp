    ...
    Rvector       &Fmul, Integer &exitFlag)
{
    ...
    SNOPT_INTEGER nS    = 0;
    SNOPT_INTEGER nInf  = 0;
    SNOPT_DOUBLE sInf   = 0.0;
    ...
    SNOPT_INTEGER snoptExitFlag = Problem.solve(0, F.GetSize(), decVec.GetSize(), 0.0, 0, 
                                    SNOPTFunctionWrapper, iAfun.data(), jAvar.data(), 
                                    A.data(), neA, iGfun.data(), jGvar.data(), numNonLinearNonZeros, 
                                    xLB.data(), xUB.data(), F_localLB.data(), F_localUB.data(), 
                                    x.data(), xstate.data(), xmul_local.data(), 
                                    F_local.data(), Fstate.data(), Fmul_local.data(),
                                    nS, nInf, sInf);
